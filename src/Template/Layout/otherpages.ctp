...
<meta property="og:url" content="www.netproacademy.net/img/<?=$course->courseimage?>" />
<meta property="og:site_name" content="NetPro Academy" />
<meta property="article:published_time" content="<?= h(Date('d,M Y h:i A', strtotime($course->postdate)))?>" />
<meta property="og:image" content="www.netproacademy.net/img/<?=$course->courseimage?>" />
  
  <meta name="twitter:card" content="summary" />
<meta name="twitter:description" content="<?=$description ?>" />
<meta name="twitter:site" content="@NetproAcademy" />
<meta name="twitter:title" content="<?=$course->title ?>" />
<meta name="twitter:image" content="www.netproacademy.net/img/<?=$course->courseimage?>" />
<link rel="alternate" type="application/rss+xml" title="NetPro Academy" href="http://www.netproacademy.net/courses/coursesfeed" />
<link rel="alternate" type="application/rss+xml" title="NetPro Academy; <?=$this->GenerateUrl($course->title)?>" href="https://www.netproacademy.net/courses/view/<?=$course->id.'/'.$this->GenerateUrl($course->title)?>" /> 
 ...
 <script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "http://netproacademy.net/courses/view/<?=$course->id.'/'.$this->GenerateUrl($course->title)?>"
  },
  "headline": "<?=$course->title?>",
  "image": {
    "@type": "ImageObject",
    "url": "http://www.netproacademy.net/courses/img/<?=$course->courseimage?>",
    "height": 800,
    "width": 800
  },
  "datePublished": "<?= h(Date('d,M Y h:i A', strtotime($course->postdate)))?>",
  "dateModified": "<?= h(Date('d,M Y h:i A', strtotime($course->postdate)))?>",
  "author": {
    "@type": "Person",
   ...
   "publisher": {
    "@type": "Organization",
    "name": "NetPro International Limited",
    "logo": {
      "@type": "ImageObject",
      "url": "http://www.netproacademy.net/img/netpro_logo.png",
      "width": 600,
      "height": 60
    }
  },
  "description": "<?= substr($$course->description,0,400)?>"
}
</script>
