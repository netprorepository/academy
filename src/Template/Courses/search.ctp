...
<div class="popular page_section">
		<div class="container">
			...
			<div class="row course_boxes">
				...
				<!-- Popular Course Item -->
        <?php if(empty($courses)){echo 'Sorry, we could not find any course matching your search, please review your search terms and try again';}
				...
				<div class="col-lg-6 nopadding">
					...
					<div class="register_section d-flex flex-column align-items-center justify-content-center">
						<div class="register_content text-center">
							<h1 class="register_title">Register now and enjoy a <span>10%</span> discount, valid till 1 March</h1>
	...
	<div class="events page_section">
		<div class="container">
			...
			<div class="event_items">
				...
				<!-- Event Item -->
          <?php if(!empty($upcomingevents)){ foreach ($courses as $course): ?>
